...
class Phase3CoachingTest {
  static final Phase3CoachingTest _instance = Phase3CoachingTest._internal();
  static Phase3CoachingTest get instance => _instance;
  
  Phase3CoachingTest._internal();

  /// Run basic Phase 3 feature tests
  Future<Map<String, dynamic>> runComprehensiveTests({
